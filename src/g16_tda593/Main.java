...
public class Main {
	...
	missions.add(new Mission(new Point[] {new Point(-3.5, 10.5)}, 2));
	missions.add(new Mission(new Point[] {new Point(10.5, -3.5)}, 3));
	missions.add(new Mission(new Point[] {new Point(10.5, 10.5)}, 4));
